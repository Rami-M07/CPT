 ...
 */
 ...
 public class RecipeManagerTest {
     ...
     public void testViewRecipes() {
         ...
         // Assert
         // Check output manually as viewRecipes prints to console
     }
     ...
     public void testUpdateRecipe() {
         ...
         // Assert
         BaseRecipe actual = RecipeManager.recipes.get(RecipeManager.recipes.size() - 1);
     ...
     public void testDeleteRecipe() {
         ...
         // Assert
         boolean recipeExists = RecipeManager.recipes.stream().anyMatch(recipe -> recipe.name.equals("DeleteTest"));
     ...
     public void testFavoriteRecipe() {
         ...
         // Assert
         BaseRecipe actual = RecipeManager.favoriteRecipes.peek();
     ...
     public void testViewFavoriteRecipes() {
         ...
         // Assert
         // Check output manually as viewFavoriteRecipes prints to console
     }
 }
